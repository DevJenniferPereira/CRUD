    ...
    <form action="cadastrousuario.php" method="post">
        <div class="container justify-content-center">
            <div class="left">
                ...
                <button class="w-100 btn btn-lg btn-primary" type="submit">Novo<?php echo strtoupper($acao); ?></button><br><br>
        ...
        <form action="cadusuario.php" method="post">
            ...
            foreach($resultado as $registro) {
                echo "<tr><td>".$registro["codigo"]."</td><td>".
                    ...
                    <a href='cadusuario.php?id=".$registro["codigo"]."&acao=editar'><span class='material-symbols-outlined'>edit</span></a>
                    <a href='cadusuario.php?id=".$registro["codigo"]."&acao=excluir'><span class='material-symbols-outlined'>delete</span></a>
                    </td></tr>";
            }
            echo "</table>";
            ?>
